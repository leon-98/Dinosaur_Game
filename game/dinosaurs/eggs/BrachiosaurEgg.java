...
/**
 * This class is responsible for brachiosaur egg
 * @author Leon
 * @version 1.0.0
 * @since 5/5/2021
 * @see Egg
 * @see FoodSource
 */
public class BrachiosaurEgg extends Egg implements FoodSource {
    /**
     * type as int, the food level amount to be gained after eating it
     */
     ...
     * @return the baby brachiosaur
     */
    @Override
    protected Dinosaur getDinosaur() {
        dinosaur=new Brachiosaur(getRandomGender());
